---
title: artesano — Galerij · Café · Sapbar in Moraira
hero:
  title: ambachtsman
  subtitle: GALERIJ • CAFÉ • SAPBAR
  tagline: Welkom bij een verfrissende verandering
welcome:
  tagline: Welkom
  title: Een verfrissende afwisseling
  image: ~/assets/images/artesano-table.jpeg
  items:
    - title: Verse gerechten, op bestelling bereid
      description: Salades, wraps, taarten, dipsauzen en nog veel meer — allemaal dagelijks ter plaatse bereid door de eigenaren Ismael en Matthew.
    - title: Vegetarisch, veganistisch en glutenvrij
      description: Een ruime keuze aan opties voor elke voedingsvoorkeur. We hebben echt voor elk wat wils.
    - title: Versgeperste sappen en smoothies
      description: Daarnaast bieden we een zorgvuldig samengestelde selectie van lokale wijnen, bieren van kleine brouwerijen en een spannend cocktailmenu.
kitchenHeading:
  tagline: Onze keuken en bar
  title: Vers, gezond en mooi
dishes:
  tagline: Gerechten
  title: Op bestelling gemaakt, elke dag
...
cocktails:
  tagline: Cocktailbar
  title: De lekkerste mojito’s die er te vinden zijn
  image: /~/assets/images/618668246_17958843992904055_443452070198879998_n.webp
  items:
    - title: Speciale cocktails
      description: Van klassieke mojito’s tot creatieve huisdrankjes — er wordt gezegd dat wij de beste mojito’s in de omgeving maken.
    - title: Lokale wijnen en ambachtelijke bieren
      description: Een zorgvuldig samengestelde selectie van lokale Spaanse wijnen en geïmporteerde bieren van kleine brouwerijen.
    - title: Verse sappen en smoothies
      description: Versgeperste sappen en smoothies, op bestelling bereid. De perfecte aanvulling op elke maaltijd.
exhibitions:
  tagline: Tentoonstellingen
  title: Lokale kunst, altijd te zien
...
testimonials:
  - title: Creatief, gezond en heerlijk!
...
team:
  - name: Ismael
    ...
    imageAlt: Ismael, eigenaar van Artesano
    description: Ismael komt oorspronkelijk uit Tanger, Marokko, en woont sinds 2009 in Spanje. Hij is een amateurfotograaf met een passie voor kunst, eten en gastvrijheid. Hij spreekt Engels, Spaans, Frans en Arabisch.
    socials:
...
cta:
  ...
  actions:
    - text: Routebeschrijving opvragen
      href: https://maps.google.com/?q=Carretera+Moraira-Calpe+16a+03724+Moraira+Alicante+España
      variant: primary
      icon: tabler:map-pin
      target: _blank
    - text: Bel +34 966 27 21 27
      href: tel:+34966272127
      icon: tabler:phone
order: 1
---

Artesano is een unieke combinatie van kunstgalerie, koffiebar, sapbar, café/restaurant en cocktaillounge.
Momenteel staat het op de tweede plaats van meer dan 200 restaurants in Moraira.
