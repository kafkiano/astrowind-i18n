...
hero:
  ...
  tagline: Bienvenidos a un cambio refrescante
welcome:
  tagline: Bienvenidos
  ...
  items:
    ...
    - title: Zumos recién exprimidos y batidos
...
cocktails:
  ...
  items:
    ...
    - title: Zumos naturales y batidos
      description: Zumos recién exprimidos y batidos preparados al momento. El complemento perfecto para cualquier comida.
exhibitions:
...
testimonials:
  - title: ¡Creativo, saludable y delicioso!
    testimonial: Un descubrimiento maravilloso en Moraira. La comida es fresca, creativa y absolutamente deliciosa. ¡Y el ambiente también es estupendo!
    name: Sarah M.
  - title: Un desayuno delicioso
    testimonial: Me pasé por allí para desayunar y me quedé impresionado. Una presentación preciosa, ingredientes frescos y un servicio muy amable.
    name: James K.
  - title: Come AQUÍ
...
Actualmente ocupa el segundo puesto entre más de 200 restaurantes de Moraira.
